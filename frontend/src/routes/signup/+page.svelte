...
<svelte:head>
  <title>Create Account - FundRadar</title>
  <meta name="description" content="Create a FundRadar account for the funding workspace." />
...
<div class="flex min-h-screen bg-white font-[Inter,ui-sans-serif,system-ui,sans-serif] text-[#191c1e] antialiased selection:bg-[#6cf8bb] selection:text-[#00714d]">
  ...
  <section class="flex h-screen w-full flex-col overflow-y-auto p-6 lg:w-1/2 lg:p-12" aria-labelledby="signup-heading">
    ...
    <main class="mx-auto flex w-full max-w-[420px] flex-1 flex-col justify-center">
      <div class="mb-8">
        <h1 id="signup-heading" class="m-0 mb-1 font-[Public_Sans] text-5xl font-bold leading-tight text-[#191c1e]">
          Create Account
        </h1>
        <p class="m-0 text-lg leading-8 text-[#45464d]">Request access to start building your funding workspace.</p>
      </div>

      {#if result.error}
        <p class="mb-5 rounded border border-red-200 bg-red-50 px-3 py-2 text-sm font-semibold text-red-700" role="alert">
          {result.error}
        </p>
      {:else if result.message}
        <p class="mb-5 rounded border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm font-semibold text-emerald-800" role="status">
          {result.message}
        </p>
      {/if}
      ...
      <form class="space-y-4" method="POST">
        ...
        <div>
          <label class="mb-2 block text-xs font-semibold uppercase leading-none tracking-normal text-[#191c1e]" for="password">
            Password
          </label>
          <div class="relative">
        ...
        <div>
          <label class="mb-2 block text-xs font-semibold uppercase leading-none tracking-normal text-[#191c1e]" for="full-name">
            Full Name
          </label>
          <div class="relative">
            <span class="material-symbols-outlined pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#45464d]">person</span>
            <input
              class="w-full rounded border border-[#76777d] bg-white py-[14px] pl-11 pr-4 text-base leading-6 text-[#191c1e] shadow-sm transition placeholder:text-[#c6c6cd] focus:border-2 focus:border-[#131b2e] focus:px-[15px] focus:py-[13px] focus:pl-[43px] focus:outline-none"
              autocomplete="name"
              id="full-name"
        ...
        <div>
          <label class="mb-2 block text-xs font-semibold uppercase leading-none tracking-normal text-[#191c1e]" for="organization">
            Organization
          </label>
          <div class="relative">
            <span class="material-symbols-outlined pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#45464d]">domain</span>
            <input
              class="w-full rounded border border-[#76777d] bg-white py-[14px] pl-11 pr-4 text-base leading-6 text-[#191c1e] shadow-sm transition placeholder:text-[#c6c6cd] focus:border-2 focus:border-[#131b2e] focus:px-[15px] focus:py-[13px] focus:pl-[43px] focus:outline-none"
        ...
        <div>
          <label class="mb-2 block text-xs font-semibold uppercase leading-none tracking-normal text-[#191c1e]" for="title">
            Role / Title
          </label>
          <div class="relative">
            <span class="material-symbols-outlined pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#45464d]">badge</span>
            <input
              class="w-full rounded border border-[#76777d] bg-white py-[14px] pl-11 pr-4 text-base leading-6 text-[#191c1e] shadow-sm transition placeholder:text-[#c6c6cd] focus:border-2 focus:border-[#131b2e] focus:px-[15px] focus:py-[13px] focus:pl-[43px] focus:outline-none"
      ...
      <div class="mt-8 text-center">
        <p class="m-0 text-base leading-6 text-[#45464d]">
          ...
          <a class="font-semibold text-emerald-700 no-underline transition hover:text-emerald-900" href={loginHref}>Sign In</a>
        </p>
      </div>
    </main>
